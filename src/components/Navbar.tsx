...
const searchable: SearchableItem[] = [
  ...
  })),
  {
    to: '/quran',
    key: 'readQuran',
    keywords: 'quran qur an surah ayah verses',
  },
  {
    to: '/hadith',
    key: 'dailyHadith',
    keywords: 'hadith bukhari sunnah sayings',
  },
  {
    to: '/duas',
    key: 'dailyDuas',
    keywords: 'dua duas supplication prayer',
  },
];
    ...
    <>
      <nav
        ...
        style={{
          ...
          borderBottom:
            '1px solid rgba(26,64,53,0.45)',
          boxShadow:
            '0 1px 0 rgba(232,189,75,0.18)',
        }}
      >
          ...
          <div className="flex items-center gap-1 ml-auto">
            <div className="relative hidden sm:block">
              <form
                ...
                className="flex items-center gap-2 bg-[#102f27]/90 border border-[#2b4d43] rounded-full px-3 py-1.5"
              >
                <Search
                  size={14}
                  className="text-noor-muted shrink-0"
                />
              ...
              {profileOpen && (
                ...
                >
                  {profile ? (
                    <>
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-noor-muted text-xs truncate">
                            {profile.email}
                          </p>
                        </div>
                      </div>
                    ...
                    <div>
                      <p className="text-noor-ivory font-medium mb-1">
                        {t(
                          'createYourNoorProfile'
                        )}
                      </p>
        ...
        {mobileOpen && (
          ...
          >
            <form
              onSubmit={submitSearch}
              className="flex items-center gap-2 bg-noor-card border border-noor-border rounded-lg px-3 py-2 mb-2"
            >
              <Search
                size={14}
                className="text-noor-muted"
              />
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `px-3 py-2.5 rounded-lg text-sm ${
                      isActive
                        ? 'text-noor-gold bg-noor-gold/10'
                        : 'text-noor-muted hover:text-noor-ivory hover:bg-white/5'
                    }`
                  }
                >
      ...
      >
        <div className="flex items-center justify-around py-2">
          {[
            {
              to: '/',
              key: 'home' as keyof TranslationKeys,
              end: true,
            },
            {
              to: '/quran',
              key: 'quran' as keyof TranslationKeys,
            },
            {
              to: '/duas',
              key: 'duas' as keyof TranslationKeys,
            },
            {
              to: '/qibla',
              key: 'qiblaFinder' as keyof TranslationKeys,
            },
            {
              to: '/blog',
              key: 'more' as keyof TranslationKeys,
            },
          ].map((link) => (
            <NavLink
              key={link.to}
